...
Built on top of the Gemini Vision training project.
Features: text + image understanding, conversation history,
contextual reasoning, ambiguity handling, response validation.
"""
